...
public extension RPCSession {
    ...
    func getInfo(_ fields: [JSONKey]? = nil, forTorrents trIds: [TrId]?, withPriority queuePriority: Operation.QueuePriority = .normal, andCompletionHandler completion: @escaping (_ torrents: Array<Torrent>?,_ removedTorrents: [TrId]?,_ error:Error?)->Void) {
