...
#define TR_RECENTLY_ACTIVE                          @"recently-active"
#define TR_METHOD_TAG                               @"tag"
#define TR_RESULT                                   @"result"
#define TR_RESULT_SUCCEED                           @"success"

#define TR_METHODNAME_TORRENTRESUME                 @"torrent-start"
#define TR_METHODNAME_TORRENTRESUMENOW              @"torrent-start-now"
...
#define TR_METHODNAME_TORRENTUP                     @"queue-move-up"
#define TR_METHODNAME_TORRENTDOWN                   @"queue-move-down"
#define TR_METHODNAME_TORRENTTOP                    @"queue-move-top"
#define TR_METHODNAME_TORRENTBOTTOM                 @"queue-move-bottom"
#define TR_METHODNAME_SESSIONGET                    @"session-get"
#define TR_METHODNAME_SESSIONSET                    @"session-set"
#define TR_METHODNAME_SESSIONSTATS                  @"session-stats"
#define TR_METHODNAME_SESSIONCLOSE                  @"session-close"
...
#define TR_ARG_FIELDS_ADDDATE                       @"addedDate"
...
#define TR_ARG_FIELDS_TRACKERADD                    @"trackerAdd"
...
#define TR_ARG_FIELDS_ISFINISHED                    @"isFinished"
#define TR_ARG_FIELDS_PEERLIMIT                     @"peer-limi"
...
#define TR_ARG_SESSION_INCOMPLETEDIR            @"incomplete-dir"
#define TR_ARG_SESSION_INCOMPLETEDIRENABLED     @"incomplete-dir-enabled"
#define TR_ARG_SESSION_TRASHFILES               @"trash-original-torrent-files"
#define TR_ARG_SESSION_SCRIPTDONEFILE           @"script-torrent-done-filename"
#define TR_ARG_SESSION_SCRIPTDONEENABLED        @"script-torrent-done-enabled"

#define TR_ARG_SESSION_DOWNLOADQUEUESIZE        @"download-queue-size"
#define TR_ARG_SESSION_DOWNLOADQUEUEENABLED     @"download-queue-enabled"
#define TR_ARG_SESSION_SEEDQUEUESIZE            @"seed-queue-size"
#define TR_ARG_SESSION_SEEDQUEUEENABLED         @"seed-queue-enabled"
#define TR_ARG_SESSION_QUEUESTALLEDMINUTES      @"queue-stalled-minutes"
#define TR_ARG_SESSION_QUEUESTALLEDENABLED      @"queue-stalled-enabled"
#define TR_ARG_SESSION_BLOCKLISTENABLED         @"blocklist-enabled"
#define TR_ARG_SESSION_BLOCKLIST                @"blocklist-url"
#define TR_ARG_SESSION_ACTIVETORRENTCOUNT       @"activeTorrentCount"
#define TR_ARG_SESSION_DOWNSPEED                @"downloadSpeed"
#define TR_ARG_SESSION_PAUSEDCOUNT              @"pausedTorrentCount"
#define TR_ARG_SESSION_TORRENTCOUNT             @"torrentCount"
#define TR_ARG_SESSION_UPLOADSPEED              @"uploadSpeed"
#define TR_ARG_SESSION_CUMULATIVESTATS          @"cumulative-stats"
#define TR_ARG_SESSION_CURRENTSTATS             @"current-stats"
#define TR_ARG_SESSION_UPLOADEDBYTES            @"uploadedBytes"
#define TR_ARG_SESSION_DOWNLOADEDBYTES          @"downloadedBytes"
#define TR_ARG_SESSION_FILESADDED               @"filesAdded"
#define TR_ARG_SESSION_SEESIONCOUNT             @"sessionCount"
#define TR_ARG_SESSION_SECONDSACCTIVE           @"secondsActive"
